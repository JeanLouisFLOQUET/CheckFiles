 ...
 */
__declspec(dllexport) int md2_file( const wchar_t *path, unsigned char output_txt[33] )
{
    FILE *f;
    size_t n;
    md2_context ctx;
    ...
    md2_finish( &ctx, output_16 );

    sprintf(output_txt
           ,"%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X"
           ,output_16[0],output_16[1],output_16[2] ,output_16[3] ,output_16[4] ,output_16[5] ,output_16[6] ,output_16[7]
           ,output_16[8],output_16[9],output_16[10],output_16[11],output_16[12],output_16[13],output_16[14],output_16[15]
           );
