...
; _CRC32ForFile($sFile)                                   : Calcule le CRC32 d'un fichier
; _MD4ForFile($sFile)                                     : Calcule le MD4 d'un fichier
; _MD5ForFile($sFile)                                     : Calcule le MD5 d'un fichier
; _SHA1ForFile($sFile)                                    : Calcule le SHA1 d'un fichier

;###############################################################################################################################################################
;Functions for CRC32 / MD4 / MD5 / SHA1
;###############################################################################################################################################################
;All these functions have been published on Internet as public resource

;Local $hTimer = TimerInit()
;Local $sData = _CRC32ForFile($sFile)
